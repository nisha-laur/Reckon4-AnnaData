        ...
        if (message !== '') {
            ...
            if (message == 'start') {
                ...
                await fetch("http://127.0.0.1:5000/chat", {
                    ...
                    .then(data => {
                        if (data["choice"] == "1") {
                            AddMessage('reciver', "Temperature: " + data['current_temp'] + " C");
                            AddMessage('reciver', "Pressure: " + data['current_pressure']);
        ...
        <div className="body">
            ...
            <div className="chat-bot-box">
                <div className="chat-detail">
                    <svg width="22" height="20" viewBox="0 0 22 20" fill="#000" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="chat-enter-box">
                    <input type="text" id='message-box' value={message} onChange={e => setmessage(e.target.value)} placeholder='Write a message' />
